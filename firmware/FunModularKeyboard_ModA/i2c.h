...
//					User configuration
//------------------------------------------------------------------------------------------------------------------
#define Enable_Debug_I2C_IRQ 1


#define I2C_Use_Master		0
#define	I2C_Use_Slave		1
#define	I2C_Use_MultiMaster	0
//------------------------------------------------------------------------------------------------------------------
...
#if (I2C_Use_MultiMaster == 1)
#undef	I2C_Use_Master
#define I2C_Use_Master		1
#undef	I2C_Use_Slave
#define	I2C_Use_Slave		1
#endif
//---------------------------------------------------------------------------------------------
